const ConverButton = (props) => {
  ...
  return (
    <div className="button convert flex">
      <button
        id="celciusButton"
        className="p-2 bg-slate-300 dark:duration-200 duration-200 rounded-s-2xl font-bold innerShadow text-blue-500 dark:bg-gray-800"
        onClick={() => {
      ...
      <button
        id="fahrenheitButton"
        bg
        className="px-5 dark:duration-200 duration-200 bg-slate-200 dark:bg-gray-700 rounded-e-2xl"
        onClick={() => {
