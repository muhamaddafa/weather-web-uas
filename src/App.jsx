							...
							<div className="grid grid-cols-12 col-span-8 gap-4 todayHighlight">
								<div className="col-span-6">
									<Highlight
										...
										satuan={"%"}
										info={
											"Shows the air humidity. Higher humidity makes it feel warmer and lower humidity makes it feel cooler."
										}
									/>
								</div>
								<div className="col-span-6">
									<Highlight
										...
										satuan={satuan}
										info={
											"Shows pressure in hPa (hectopascal). Higher pressure indicates calm weather and lower pressure indicates unsettled weather."
										}
									/>
								</div>
								<div className="col-span-6">
									<Highlight
										...
										satuan={" km/h"}
										info={
											"Shows the wind speed in km/h (kilometer per hour). Stronger winds can be associated with storms or gusty weather, Calmer winds indicates a tranquil weather environment."
										}
									/>
								</div>
								<div className="col-span-6">
									<Highlight
										...
										satuan={" km"}
										info={
											"Shows visibility range in km (kilometer). Good visibility means objects can be seen over long distances, while poor visibility implies reduced clarity and limited sight range."
										}
									/>
								</div>
							</div>
